...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.accepted.connect(lambda: self.deleteAdmin(Dialog))
        self.buttonBox.rejected.connect(Dialog.close)
        self.retranslateUi(Dialog)
        QtCore.QMetaObject.connectSlotsByName(Dialog)
    def deleteAdmin(self, Dialog):
        import db
        db.delAdmin(Eid)
        QtWidgets.QMessageBox.about(Dialog, 'Successfully Deleted!', 'Admin Successfully Deleted!')
        Dialog.close()
