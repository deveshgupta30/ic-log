...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.accepted.connect(lambda: self.deleteStudent(Dialog))
    ...
    def deleteStudent(self, Dialog):
        import db
        db.delStudent(Rno)
        QtWidgets.QMessageBox.about(Dialog, 'Successfully Deleted!', 'Student Successfully Deleted!')
        Dialog.close()
